        ...
        <div class="achievement-details-overlay active" id="achievement-details">
            <div class="achievement-details-container glass-effect">
                ...
                <div class="details-actions" style="display: flex; gap: 10px;">
                    <button class="btn ripple" id="close-details-btn" style="flex: 1; background: rgba(255,255,255,0.1);">
                        إغلاق
                    </button>
                    ${isEarned ? `
                    <button class="btn ripple" id="share-achievement-btn" style="flex: 1; background: var(--accent);">
